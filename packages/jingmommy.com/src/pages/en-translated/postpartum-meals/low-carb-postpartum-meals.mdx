...
<div style="text-align: center; font-weight: bold; color: #ff1493;">Jingmommy Low-Carb Postpartum Meals {usd(products.local_lowcarb_30d.price)} (Los Angeles area, delivery area restrictions apply)</div>
  ...
  data={[
    {
      ...
      icon: 'mdi:cart',
      url: orderUrl('local_lowcarb', 'en-translated')
    },
    {
