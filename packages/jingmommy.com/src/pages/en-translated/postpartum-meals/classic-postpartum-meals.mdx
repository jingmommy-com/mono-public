...
<p class={`text-center font-bold text-${frontmatter.color}-600`}>Jingmommy Classic Postpartum Meals {usd(products.local_classic_30d.price)} (Los Angeles area, delivery area restrictions apply)</p>
  ...
  data={[
    {
      ...
      icon: 'mdi:cart',
      url: orderUrl('local_classic', 'en-translated')
    },
    {
